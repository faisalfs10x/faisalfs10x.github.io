---
layout: single
title: "CVE Disclosures & Security Research"
...
Critical infrastructure monitoring platform with multiple access control and XSS flaws discovered.
...
Enterprise monitoring and management platform with authorization and RCE vulnerabilities.
...
**Impact:** Unauthenticated SQL injection enables database extraction; access control flaws allow unauthorized data manipulation and privilege escalation.
...
IP address management platform with privilege escalation and XSS vulnerabilities.
...
Remote system administration tool with critical access control bypass leading to RCE.
...
**Impact:** Access control bypass allows authenticated or unauthenticated attackers to execute arbitrary commands as root. File manager access control flaw enables unauthorized file operations.
